...
public class BuiltinMessageAnnotationsType implements AMQPType<MessageAnnotations>, BuiltinDescribedTypeConstructor<MessageAnnotations> {
    ...
    public BuiltinMessageAnnotationsType(EncoderImpl encoder) {
    ...
    public static void register(Decoder decoder, EncoderImpl encoder) {
        BuiltinMessageAnnotationsType type = new BuiltinMessageAnnotationsType(encoder);
