...
/**
 * Interface for Buffer object passed to and returned from various methods of the
 * Proton API.  Allows for the use of various buffer implementations without needing
 * to tie the Proton API to any specific implementation.
 */
public interface ProtonBuffer {
    ...
    /**
     * Creates a new buffer whose content is a subsequence of this buffer's content.
     *
     ...
     *
     * @return a new ProtonBuffer that is a shared view of a subset this buffer.
     */
    ProtonBuffer slice();
